...
let PermissionCategoryRepository = class PermissionCategoryRepository extends typeorm_1.Repository {
};
PermissionCategoryRepository = __decorate([
    typeorm_1.EntityRepository(permission_category_entity_1.PermissionCategories)
