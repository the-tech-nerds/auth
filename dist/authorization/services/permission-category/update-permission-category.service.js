...
exports.UpdatePermissionCategoryService = void 0;
...
let UpdatePermissionCategoryService = class UpdatePermissionCategoryService extends authorization_service_1.AuthorizationService {
    constructor(permissionCategoryRepository) {
        super();
        this.permissionCategoryRepository = permissionCategoryRepository;
    }
    async update(id, permissionCategoryRequest) {
...
UpdatePermissionCategoryService = __decorate([
    common_1.Injectable(),
...
exports.UpdatePermissionCategoryService = UpdatePermissionCategoryService;
//# sourceMappingURL=update-permission-category.service.js.map