...
exports.CreatePasswordService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const bcryptjs_1 = require("bcryptjs");
const user_entity_1 = require("../../user/entities/user.entity");
let CreatePasswordService = class CreatePasswordService {
    ...
    async execute(createPasswordRequest) {
        ...
        user.password = await bcryptjs_1.hash(createPasswordRequest.new_password, 10);
        await this.userRepository.save(user);
        return true;
    }
};
CreatePasswordService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(user_entity_1.User)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], CreatePasswordService);
exports.CreatePasswordService = CreatePasswordService;
//# sourceMappingURL=create-password.servic e.js.map