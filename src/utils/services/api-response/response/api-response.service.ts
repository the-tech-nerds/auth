...
export class ApiResponseService {
  response(message: string[] | string, status: string, code: number,
    data: any[] | any, res: Response): Response<ResponseModel> {
